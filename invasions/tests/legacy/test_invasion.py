...
from irus import IrusInvasion, IrusLadder, IrusMember, IrusMemberList

from .lambdaclient import LambdaClient

client = LambdaClient(local=True)

logger = Logger(service="test_invasion", level="INFO", correlation_id=True)
