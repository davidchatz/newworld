...
from irus import IrusInvasion, IrusLadder, IrusMember
...
def download_sample_ladder_file():
    invasion = IrusInvasion.from_user(
        day=23, month=5, year=2024, settlement="wf", win=True
    )
    ...
    result = client.lambda_client.invoke(
...
def generate_invasion_ladders():
    ...
    for f in [
        "Screenshot_2024-05-23_222523.png",
        "Screenshot_2024-05-23_222537.png",
        "Screenshot_2024-05-23_222607.png",
        "Screenshot_2024-05-23_222625.png",
        "Screenshot_2024-05-23_222639.png",
        "Screenshot_2024-05-23_222655.png",
        "Screenshot_2024-05-23_222705.png",
    ]:
        url = test_bucket.meta.client.generate_presigned_url(
            "get_object", Params={"Bucket": test_bucket_name, "Key": f"20240523-wf/{f}"}
        )
        logger.debug(f"URL: {url}")
...
def test_download_sample_ladder_file(download_sample_ladder_file):
    ...
    assert (
        download_sample_ladder_file["body"]
        == '"Successful download of Screenshot_2024-05-23_222523.png. Ladder for invasion 20240523-wf with 8 rank(s) including 1 member(s)"'
    )
