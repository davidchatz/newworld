...
def invasionlist_from_month():
    invasion_20240501 = IrusInvasion.from_user(
        day=1, month=5, year=2024, settlement="ww", win=True
    )
    invasion_20240502 = IrusInvasion.from_user(
        day=2, month=5, year=2024, settlement="ck", win=True
    )
    invasion_20240601 = IrusInvasion.from_user(
        day=1, month=6, year=2024, settlement="mb", win=True
    )
